      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="bg-white dark:bg-black border border-green-200 dark:border-green-800 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-xl shadow-green-500/5 mb-6 sm:mb-8">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8">
            {/* অ্যাভাটার - ইউজারপেইজের মতো স্টাইল */}
            <div className="relative group">
              {/* ব্লার ইফেক্ট */}
              <div className="absolute inset-0 bg-gradient-to-br from-green-600 to-green-500 dark:from-green-500 dark:to-green-400 rounded-full blur-xl opacity-30 group-hover:opacity-50 transition-opacity"></div>
              ...
              <div className="relative w-28 h-28 sm:w-32 sm:h-32 lg:w-36 lg:h-36 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl">
                {/* ইউজারপেইজের মতো ইমেজ হ্যান্ডলিং */}
              ...
              <Link
                ...
                className="absolute -top-2 -right-2 w-8 h-8 bg-green-500 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-lg hover:bg-green-600 hover:scale-110"
              >
                <svg
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4 mt-4">
                <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/30 rounded-xl p-3 sm:p-4 text-center hover:shadow-md transition-all hover:scale-105">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* পার্সোনাল ইনফো */}
          <div className="bg-gradient-to-br from-white to-green-50 dark:from-black dark:to-green-950/20 border border-green-200 dark:border-green-800 rounded-xl p-6 hover:shadow-xl transition-all hover:scale-[1.02]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400 group hover:text-green-600 dark:hover:text-green-400 transition-colors">
                <svg
          ...
          <div className="bg-gradient-to-br from-white to-green-50 dark:from-black dark:to-green-950/20 border border-green-200 dark:border-green-800 rounded-xl p-6 hover:shadow-xl transition-all hover:scale-[1.02]">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-2 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/20 transition-colors">
                ...
                <span className="px-3 py-1 bg-gradient-to-r from-green-600 to-green-500 dark:from-green-500 dark:to-green-400 text-white dark:text-black rounded-full text-sm font-medium">
                  {user.role || "User"}
                </span>
              </div>
              ...
              <div className="pt-4 border-t border-green-200 dark:border-green-800">
                <button
                  ...
                  className="w-full px-4 py-2.5 bg-gradient-to-r from-green-600 to-green-500 dark:from-green-500 dark:to-green-400 text-white dark:text-black font-semibold rounded-lg hover:from-green-700 hover:to-green-600 dark:hover:from-green-400 dark:hover:to-green-500 transform hover:scale-105 transition-all shadow-lg shadow-green-500/25 dark:shadow-green-500/10 flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
