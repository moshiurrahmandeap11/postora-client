...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen mt-20 flex items-center justify-center p-4 bg-gradient-to-br from-green-50 via-white to-green-100 dark:from-green-950 dark:via-black dark:to-green-900">
